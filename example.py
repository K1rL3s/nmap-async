...
async def main() -> None:
    nm = nmap.port_scanner.PortScanner()  # instantiate nmap.PortScanner object
    await nm.async_init()

    await nm.scan("127.0.0.1", "22-443")  # scan host 127.0.0.1, ports from 22 to 443
    ...
    # get one hostname for host 127.0.0.1, usualy the user record
    nm["127.0.0.1"].hostname()

    # get list of hostnames for host 127.0.0.1 as a list of dict
    ...
    if nm["127.0.0.1"].has_tcp(22):
        nm["127.0.0.1"]["tcp"][22]  # get infos about port 22 in tcp on host 127.0.0.1
        nm["127.0.0.1"].tcp(22)  # get infos about port 22 in tcp on host 127.0.0.1
        # get state of port 22/tcp on host 127.0.0.1 (open
    ...
    await nm.scan(hosts="192.168.0.0/24", arguments="-n -sP -PE -PA21,23,80,3389")
    ...
    if os.getuid() == 0:
        ...
        await nm.scan("127.0.0.1", arguments="-O")
        ...
        await nm.scan("192.168.0.0/24", arguments="-O")
